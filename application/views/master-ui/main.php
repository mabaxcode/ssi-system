...
<base href="../" />
		...
		<link rel="canonical" href="http://preview.keenthemes.comdashboards/call-center.html" />
			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
					...
					<div class="d-flex flex-stack flex-grow-1">
						<div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
							...
							<a href="javascript:void(0);" class="app-sidebar-logo">
								<img alt="Logo" src="<?=base_url()?>assets/logo/my-logo.png" class="h-25px theme-light-show" />
								<img alt="Logo" src="<?=base_url()?>assets/logo/my-logo.png" class="h-25px theme-dark-show" />
							</a>
							...
							<div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-content d-flex align-items-center px-3">
											...
											<div class="d-flex flex-column">
												...
												<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">
													<? if($this->session->userdata('user_type') == '1'){echo "User";} ?>
													<? if($this->session->userdata('user_type') == '2'){echo "Teacher";} ?>
													<? if($this->session->userdata('user_type') == '3'){echo "Admin";} ?>
												</span></div>
									...
									<div class="menu-item px-5">
										<a href="<?=base_url('main/my_profile')?>" class="menu-link px-5">My Profile</a>
									</div>
									<!--end::Menu item-->
									<!--end::Menu item-->
									<!--begin::Menu item-->
									<div class="menu-item px-5 my-1">
										<a href="<?=base_url('main/setting')?>" class="menu-link px-5">Account Settings</a>
									</div>
									*/?>
									<!--end::Menu item-->
									<!--begin::Menu item-->
				...
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					...
					<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
						...
						<!--end::Content wrapper-->
						<!--begin::Footer-->
						<? $this->load->view('master-ui/footer'); ?>
						<!--end::Footer-->
					</div>
					<!--end:::Main-->
				</div>
								...
								<div class="timeline-content mb-10 mt-n1">
									...
									<div class="overflow-auto pb-5">
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="apps/projects/project.html" class="w-30px me-3" src="<?=base_url()?>assets/media/svg/files/doc.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
											...
											<div class="d-flex flex-aligns-center">
												<!--begin::Icon-->
												<img alt="apps/projects/project.html" class="w-30px me-3" src="<?=base_url()?>assets/media/svg/files/css.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
								...
								<div class="current" data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="fv-row mb-10">
											...
											<style>.image-input-placeholder { background-image: url('<?=base_url()?>assets/media/svg/files/blank-image.svg'); } [data-bs-theme="dark"] .image-input-placeholder { background-image: url('<?=base_url()?>assets/media/svg/files/blank-image-dark.svg'); }</style>
